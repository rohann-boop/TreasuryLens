...
const THEME_SEEDS: IdeaSeed[] = [
  ...
  themeSeed({
    id: "dxyz",
    ticker: "DXYZ",
    companyName: "Destiny Tech100, Inc.",
    role: "high-variance-optionality",
    sectionKey: "frontier-high-upside",
    themes: ["Frontier", "Private markets / venture", "Closed-end fund", "Pre-IPO exposure"],
    targetOutcome: "Optionality — venture-style exposure to private tech, very wide distribution",
    convictionScore: 38,
    thesis: [
      "Closed-end fund providing rare listed exposure to a basket of late-stage private tech / AI companies (e.g. pre-IPO names).",
      "Optionality on private-market winners realizing value through IPOs or up-rounds.",
      "A single liquid ticker to express venture-style exposure normally gated to private allocators.",
    ],
    whatMustBeTrue: [
      "Underlying private holdings mark up and eventually realize liquidity.",
      "The fund's premium/discount to NAV stays within a reasonable band.",
      "Portfolio company fundamentals justify carrying valuations.",
    ],
    catalysts: ["Portfolio-company IPOs / up-rounds", "NAV mark-ups", "Discount-to-NAV narrowing"],
    risks: [
      "Has historically traded at a large premium/discount to stated NAV — price can dislocate badly from underlying value.",
      "Illiquid, hard-to-value private holdings with stale marks.",
      "Concentration in a handful of venture names; binary outcomes.",
    ],
    killCriteria: ["Persistent extreme premium to NAV", "Major write-downs across core holdings", "Liquidity / structure concerns at the fund level"],
    downsideGuardrail: "Backed by a portfolio of private holdings, but NAV is uncertain and the market price can detach sharply — treat as a high-variance bet.",
    positionSizingBand: "watchlist",
    positionSizingNote: "Educational label only: venture-style variance plus NAV-dislocation risk suits a very small watchlist-sized research stake.",
    reviewFrequency: "On NAV updates / portfolio liquidity events",
    reviewStatus: "monitoring",
    checklist: { thesis: 50, valuation: 32, momentum: 45, management: 50, balanceSheet: 48, catalyst: 45, data: 40 },
    scenario: { marketCapBucket: "small", scenarioPotential: "3x potential", riskLevel: "high" },
  }),
  themeSeed({
    id: "vcx",
    ticker: "VCX",
    companyName: "VCX — verify ticker / issuer before acting",
    role: "high-variance-optionality",
    sectionKey: "frontier-high-upside",
    ...
    convictionScore: 30,
    thesis: [
      "Added as a frontier watchlist entry at user request. The ticker symbol 'VCX' is ambiguous and must be verified against the intended issuer and exchange before any thesis is built.",
      "Live pricing is attached on a best-effort basis only; do not treat any auto-fetched figures as confirmed for this name.",
    ],
    whatMustBeTrue: [
      "Confirm which company/exchange 'VCX' refers to and that it matches the intended idea.",
      "Verify the auto-fetched price/series actually corresponds to that issuer.",
    ...
    risks: [
      "Ticker may be ambiguous, recently listed, or map to an unintended issuer — auto-fetched data may be wrong or absent.",
      "No verified fundamentals or thesis yet; placeholder only.",
    ],
    killCriteria: ["Ticker cannot be verified to a real intended issuer", "Auto-fetched data proves unreliable"],
    ...
    checklist: { thesis: 25, valuation: 25, momentum: 30, management: 25, balanceSheet: 25, catalyst: 30, data: 25 },
    scenario: { marketCapBucket: "small", scenarioPotential: "2x potential", riskLevel: "high" },
  }),
  themeSeed({
    id: "crbs",
    ticker: "CRBS",
    companyName: "CRBS — verify ticker / issuer before acting",
    role: "high-variance-optionality",
    sectionKey: "frontier-high-upside",
    themes: ["Frontier", "Unverified ticker", "Watchlist — needs verification"],
    targetOutcome: "Watchlist placeholder — confirm the issuer behind this symbol before research",
    convictionScore: 30,
    thesis: [
      "Added as a frontier watchlist entry at user request. The ticker symbol 'CRBS' is ambiguous / may be unavailable from the price provider and must be verified before any thesis is built.",
      "If no price series resolves, the card degrades gracefully to curated content only — that is expected for an unverified name.",
    ],
    whatMustBeTrue: [
      "Confirm which company/exchange 'CRBS' refers to and that it matches the intended idea.",
