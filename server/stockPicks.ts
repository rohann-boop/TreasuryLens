...
const PICKS: StockPick[] = [
  ...
  },
  {
    ...
    riskLevel: "moderate",
    downsideGuardrail:
      "Adjacent industrial AI/diagnostics exposure; included as a diversifier, not a pure energy play.",
    upsideCase:
      "AI-enabled medical imaging analytics layered on its installed base monetize a recurring software tail.",
    whatMustBeTrue: [
      "AI imaging products attach to a meaningful share of new sales.",
      "Service tail continues to expand.",
      "Hospital capex stabilizes.",
    ],
    thesis: [
      "Installed base of imaging hardware is a moat for AI software.",
      "Recurring service revenue grows with fleet.",
      "Optionality on agentic clinical workflows.",
    ],
    risks: [
      "Hospital capex cyclicality.",
      "Reimbursement / FDA risk on AI features.",
      "Currency exposure.",
    ],
    removalTriggers: [
      "AI feature attach growth stalls.",
      "Service margin compression.",
    ],
    dataConfidence: "curated",
    sourceNote:
      CURATED_SOURCE + " Adjacent diversifier; not a pure energy name.",
    issuerCountry: "US",
  },
  {
    ticker: "DUK",
